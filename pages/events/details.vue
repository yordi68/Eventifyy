...
<template>
        <div class="px-32">
                <div class="w-full mt-5">
                        <img src="/event-20.png" alt="random image" class="w-full h-full object-cover " />
                </div>
                <div class="flex justify-between my-6">
                        <h3 class="font-bold text-4xl">Sound Of Christmas 2023</h3>
                        <div>
                ...
                <div class="w-full my-8">
                        ...
                        <p>
                                Get ready to kick off the Christmas season in Mumbai with SOUND OF CHRISTMAS - your
                                favourite LIVE Christmas concert!

                                City Youth Movement invites you to the 4th edition of our annual Christmas festivities -
                                by the youth and for the youth! Feat. your favourite worship leaders, carols, quizzes
                                and some exciting surprises!

                                Bring your family and friends and sing along your favourite Christmas carols on the 2nd
                                of December, 6:30 PM onwards at the Balgandharva Rang Mandir, Bandra West. Book your
                                tickets now!
                ...
                <div class="w-1/2 my-8 ">
                        ...
                        <div class="flex items-center justify-start flex-wrap">
                                <button type="button"
                                        class="text-black border border-white bg-gray-200 hover:border-gray-200 dark:border-gray-900 dark:bg-gray-900 dark:hover:border-gray-700 x focus:ring-4 focus:outline-none focus:ring-gray-300 rounded-full text-base font-medium px-5 py-2.5 text-center me-3 mb-3 dark:text-white dark:focus:ring-gray-800">
                                        Shoes
                                </button>
                                <button type="button"
                                        class="text-black border border-white bg-gray-200 hover:border-gray-200 dark:border-gray-900 dark:bg-gray-900 dark:hover:border-gray-700 x focus:ring-4 focus:outline-none focus:ring-gray-300 rounded-full text-base font-medium px-5 py-2.5 text-center me-3 mb-3 dark:text-white dark:focus:ring-gray-800">
