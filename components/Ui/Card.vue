...
// const datetime = ref('2024-05-28T13:31:00+00:00');
...
<template>
        <div class=" flex justify-between space-x-6 items-center p-8 px-4 shadow-md">

                <div class="flex h-56 w-full  space-x-4">
                        ...
                        <div class="flex flex-col py-3 space-y-2 justify-start items-start w-1/2">
                                ...
                                <p>{{ event.date }}</p>
                                <span class="flex flex-col items-st  space-x-4 ">
                                        <div class="flex">
                                ...
                                <div class="flex items-center justify-between space-x-8">
                                        <div @click="$router.push(`/user/event/edit/${event.id}`)" v-if="hasIcon"
